...
const Button: React.FC<ButtonProps> = ({ bgColor, textColor, color, size }) => {
  return (
    <>
      ...
      <button className="text-green-400 bg-yellow-200">propsなしボタンです</button>
      <button
        className={classNames(
          ...
          { 'px-4 py-1 text-base sm:px-7 sm:py-1 sm:text-lg md:px-12 md:py-2': size === 'lg' },
          { 'px-2 py-1 text-sm sm:px-4 sm:py-1 sm:text-base md:px-7 md:py-2': size === 'sm' }
        )}
      >
        ボタン
      </button>
